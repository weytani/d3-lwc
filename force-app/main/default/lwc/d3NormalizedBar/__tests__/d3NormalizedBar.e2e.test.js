...
describe("c-d3-normalized-bar e2e", () => {
  ...
  describe("full lifecycle", () => {
    ...
    it("create -> load D3 -> load data -> render -> verify SVG creation, always via stackOffsetExpand", async () => {
  ...
  describe("error recovery", () => {
    ...
    it("missing seriesField -> error state — nothing to normalize", async () => {
      const element = await createChart({
        recordCollection: [
          { StageName: "Prospecting", Type: "New", Amount: 100 }
        ],

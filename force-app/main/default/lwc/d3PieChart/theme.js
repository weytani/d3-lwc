// ABOUTME: Bundle-local color palettes and helpers for the d3PieChart standalone bundle.
// ABOUTME: Provides the SLDS-aligned palettes and getColors used to color the slices.

// ABOUTME: Bundle-local data processing for the d3StepChart standalone bundle.
...
/**
 * Per-chart-type record limit for the step chart, tuned to visual capacity.
 * Time series comprehension ceiling (matches the line chart).
 */

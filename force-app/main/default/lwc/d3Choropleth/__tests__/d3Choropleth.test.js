...
jest.mock('@salesforce/resourceUrl/usStates', () => '/mock/usStates.json', { virtual: true });
    ...
    features: [
        {
            ...
            geometry: {
                type: 'Polygon',
                coordinates: [[[-120, 35], [-115, 35], [-115, 40], [-120, 40], [-120, 35]]]
            }
        },
        {
            type: 'Feature',
            ...
            geometry: {
                type: 'Polygon',
                coordinates: [[[-100, 30], [-95, 30], [-95, 35], [-100, 35], [-100, 30]]]
            }
        },
        {
            type: 'Feature',
            ...
            geometry: {
                type: 'Polygon',
                coordinates: [[[-75, 40], [-70, 40], [-70, 45], [-75, 45], [-75, 40]]]
            }
        },
        {
            type: 'Feature',
            ...
            geometry: {
                type: 'Polygon',
                coordinates: [[[-85, 25], [-80, 25], [-80, 30], [-85, 30], [-85, 25]]]
            }
        },
        {
            type: 'Feature',
            ...
            geometry: {
                type: 'Polygon',
                coordinates: [[[-90, 37], [-87, 37], [-87, 42], [-90, 42], [-90, 37]]]
            }
        }
    ]
};
...
const createMockD3 = () => {
    const mockD3 = {
        ...
        interpolateRgbBasis: jest.fn((colors) => (t) => colors[0]),
        // Zoom mock
        zoom: jest.fn(() => {
            const zoom = {
    ...
    describe('GeoJSON handling', () => {
        ...
        it('uses custom GeoJSON when provided', async () => {
            await createChart({
                ...
                recordCollection: [
                    { Id: '1', Region: 'REGION-A', Value: 100 }
                ],
                regionField: 'Region',
                valueField: 'Value'
            });

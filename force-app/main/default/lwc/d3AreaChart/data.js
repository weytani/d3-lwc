...
/**
 * Area chart record limit — visual comprehension ceiling for a time series.
 * The chart imports this as the default cap for the recordCollection path.
 */
export const AREA_RECORD_LIMIT = 1000;

// ABOUTME: Tests the additive GraphQL self-fetch path on d3AreaChart (Approach A, CT-REC).
// ABOUTME: Area has no server-side aggregate — the graphql path always fetches raw
...
describe("d3AreaChart GraphQL path (Approach A, CT-REC)", () => {
  let d3Calls;
  ...
  it("renders the chart container and actually draws the area when GraphQL record data arrives", async () => {

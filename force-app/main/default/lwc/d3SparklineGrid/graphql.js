// ABOUTME: Bundle-local Salesforce GraphQL (v2) record-query builder and normalizer for the d3SparklineGrid bundle.
 ...
 * Used by both the structured self-fetch path (project the entity/date/value
 * fields, then group + bucket client-side) and the free-text `graphqlQuery`

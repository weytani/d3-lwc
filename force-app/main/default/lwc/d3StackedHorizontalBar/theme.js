// ABOUTME: Bundle-local color palettes and helpers for the d3StackedHorizontalBar standalone bundle.
// ABOUTME: Provides the SLDS-aligned palettes and getColors used to color the stacked series.

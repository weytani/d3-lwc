 ...
 * Used by both the Count path (project the group-by and series fields, then
...
/**
 * Normalizes a grouped-aggregate wire result into [{label,value}] for simple bars.
 ...
 * [{label,series,value}] for stacked/matrix charts.
 * @param {object} data wire `data`

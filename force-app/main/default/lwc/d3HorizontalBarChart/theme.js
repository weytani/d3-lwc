// ABOUTME: Bundle-local color palettes and helpers for the d3HorizontalBarChart standalone bundle.
// ABOUTME: Provides the SLDS-aligned palettes and getColors used to color the horizontal bars.

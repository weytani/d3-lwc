// ABOUTME: Bundle-local Salesforce GraphQL (v2) record-query builder and normalizer for the d3VariableColorLine bundle.
 ...
 * Used by both the structured self-fetch path (project the date/value fields) and
 * the free-text `graphqlQuery` override. When `objectApiName` is omitted or absent

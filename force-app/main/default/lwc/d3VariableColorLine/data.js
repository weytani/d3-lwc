...
/**
 * Per-chart-type record limit tuned to visual capacity. This bundle reads only
 * its own VARIABLE_COLOR_LINE ceiling — a time series' visual comprehension cap.
 */
export const CHART_LIMITS = {
  VARIABLE_COLOR_LINE: 1000
};

...
const mockD3 = {
    ...
    scaleOrdinal: jest.fn(() => {
        const scale = jest.fn((val) => '#1589EE');
        scale.domain = jest.fn(() => scale);
        scale.range = jest.fn(() => scale);
        return scale;
    }),
...
// Sample test data
const SAMPLE_DATA = [
    { Id: '001xx000003DGb1', Amount: 10000, Probability: 20, StageName: 'Prospecting' },
    { Id: '001xx000003DGb2', Amount: 25000, Probability: 50, StageName: 'Qualification' },
    { Id: '001xx000003DGb3', Amount: 50000, Probability: 75, StageName: 'Proposal' },
    { Id: '001xx000003DGb4', Amount: 75000, Probability: 90, StageName: 'Negotiation' },
    { Id: '001xx000003DGb5', Amount: 100000, Probability: 100, StageName: 'Closed Won' }
];
...
describe('c-d3-scatter-plot', () => {
    ...
    describe('correlation calculation', () => {
        it('calculates correlation when showCorrelation is true', async () => {
            ...
            const correlationInfo = element.shadowRoot.querySelector('.correlation-info');
            // Note: Due to template conditionals, this may or may not be present

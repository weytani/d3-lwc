...
describe("c-d3-band-chart e2e", () => {
  ...
  describe("full lifecycle", () => {
    const LIFECYCLE_DATA = [
      ...
      { CloseDate: "2024-02-01", Amount: 200, ExpectedRevenue: 260 },
      { CloseDate: "2024-03-01", Amount: 150, ExpectedRevenue: 220 }
    ];

    it("create -> load D3 -> load data -> render -> verify band SVG creation", async () => {
  ...
  describe("error recovery", () => {
    ...
    it("SOQL fetch path: no recordCollection -> Apex returns data -> full pipeline", async () => {
      const soqlData = [
        { CloseDate: "2024-01-01", Amount: 400, ExpectedRevenue: 460 },
  ...
  describe("multi-component isolation", () => {
    it("two charts on same page have independent lifecycle", async () => {
      ...
      const dataB = [
        ...
        { CloseDate: "2024-02-01", Amount: 400, ExpectedRevenue: 470 }
      ];

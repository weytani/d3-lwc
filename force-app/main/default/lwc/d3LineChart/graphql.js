// ABOUTME: Bundle-local Salesforce GraphQL (v2) record-query builder and normalizer for the d3LineChart bundle.
 ...
 * fields, then shape into time-series points) and the free-text `graphqlQuery`
 * override. When `objectApiName` is omitted or absent from the payload, the

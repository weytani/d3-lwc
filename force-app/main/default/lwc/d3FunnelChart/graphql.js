// ABOUTME: Bundle-local Salesforce GraphQL (v2) query builders and normalizers for the d3FunnelChart bundle.
...
/**
 * Normalizes a grouped-aggregate wire result into [{label,value}] for the funnel chart.
